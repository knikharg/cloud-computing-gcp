...
public final class KeyValueStoreGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.Keyvalue.Key,
      stub.Keyvalue.KeyValue> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "get",
      requestType = stub.Keyvalue.Key.class,
      responseType = stub.Keyvalue.KeyValue.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<stub.Keyvalue.Key,
      stub.Keyvalue.KeyValue> getGetMethod() {
    io.grpc.MethodDescriptor<stub.Keyvalue.Key, stub.Keyvalue.KeyValue> getGetMethod;
      ...
      synchronized (KeyValueStoreGrpc.class) {
        if ((getGetMethod = KeyValueStoreGrpc.getGetMethod) == null) {
          KeyValueStoreGrpc.getGetMethod = getGetMethod = 
              io.grpc.MethodDescriptor.<stub.Keyvalue.Key, stub.Keyvalue.KeyValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "KeyValueStore", "get"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Keyvalue.Key.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Keyvalue.KeyValue.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<stub.Keyvalue.KeyValue,
      stub.Keyvalue.APIResponse> getSetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "set",
      requestType = stub.Keyvalue.KeyValue.class,
      responseType = stub.Keyvalue.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<stub.Keyvalue.KeyValue,
      stub.Keyvalue.APIResponse> getSetMethod() {
    io.grpc.MethodDescriptor<stub.Keyvalue.KeyValue, stub.Keyvalue.APIResponse> getSetMethod;
    if ((getSetMethod = KeyValueStoreGrpc.getSetMethod) == null) {
      synchronized (KeyValueStoreGrpc.class) {
        if ((getSetMethod = KeyValueStoreGrpc.getSetMethod) == null) {
          KeyValueStoreGrpc.getSetMethod = getSetMethod = 
              io.grpc.MethodDescriptor.<stub.Keyvalue.KeyValue, stub.Keyvalue.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "KeyValueStore", "set"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Keyvalue.KeyValue.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Keyvalue.APIResponse.getDefaultInstance()))
  ...
  public static abstract class KeyValueStoreImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void get(stub.Keyvalue.Key request,
        io.grpc.stub.StreamObserver<stub.Keyvalue.KeyValue> responseObserver) {
      asyncUnimplementedUnaryCall(getGetMethod(), responseObserver);
    }

    /**
     */
    public void set(stub.Keyvalue.KeyValue request,
        io.grpc.stub.StreamObserver<stub.Keyvalue.APIResponse> responseObserver) {
  ...
  public static final class KeyValueStoreBlockingStub extends io.grpc.stub.AbstractStub<KeyValueStoreBlockingStub> {
    ...
    /**
     */
    public stub.Keyvalue.KeyValue get(stub.Keyvalue.Key request) {
    ...
    /**
     */
    public stub.Keyvalue.APIResponse set(stub.Keyvalue.KeyValue request) {
      return blockingUnaryCall(
  ...
  public static final class KeyValueStoreFutureStub extends io.grpc.stub.AbstractStub<KeyValueStoreFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<stub.Keyvalue.KeyValue> get(
        stub.Keyvalue.Key request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<stub.Keyvalue.APIResponse> set(
        stub.Keyvalue.KeyValue request) {
      return futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET:
          serviceImpl.get((stub.Keyvalue.Key) request,
              (io.grpc.stub.StreamObserver<stub.Keyvalue.KeyValue>) responseObserver);
          break;
        case METHODID_SET:
          serviceImpl.set((stub.Keyvalue.KeyValue) request,
              (io.grpc.stub.StreamObserver<stub.Keyvalue.APIResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeyValueStoreBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return stub.Keyvalue.getDescriptor();
    }
