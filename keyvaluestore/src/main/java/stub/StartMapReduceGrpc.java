...
public final class StartMapReduceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.Master.Config,
      stub.Master.APIResponse> getInitiateSplitMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "initiateSplit",
  ...
  public static io.grpc.MethodDescriptor<stub.Master.Config,
      stub.Master.APIResponse> getInitiateSplitMethod() {
    io.grpc.MethodDescriptor<stub.Master.Config, stub.Master.APIResponse> getInitiateSplitMethod;
    if ((getInitiateSplitMethod = StartMapReduceGrpc.getInitiateSplitMethod) == null) {
      synchronized (StartMapReduceGrpc.class) {
        if ((getInitiateSplitMethod = StartMapReduceGrpc.getInitiateSplitMethod) == null) {
          StartMapReduceGrpc.getInitiateSplitMethod = getInitiateSplitMethod = 
              io.grpc.MethodDescriptor.<stub.Master.Config, stub.Master.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "StartMapReduce", "initiateSplit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Master.Config.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Master.APIResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new StartMapReduceMethodDescriptorSupplier("initiateSplit"))
                  .build();
          }
        }
     }
     return getInitiateSplitMethod;
  }
  ...
  public static abstract class StartMapReduceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void initiateSplit(stub.Master.Config request,
        io.grpc.stub.StreamObserver<stub.Master.APIResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getInitiateSplitMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getInitiateSplitMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                stub.Master.Config,
                stub.Master.APIResponse>(
                  this, METHODID_INITIATE_SPLIT)))
          .build();
    }
  }
  ...
  public static final class StartMapReduceStub extends io.grpc.stub.AbstractStub<StartMapReduceStub> {
    ...
    public void initiateSplit(stub.Master.Config request,
        io.grpc.stub.StreamObserver<stub.Master.APIResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getInitiateSplitMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class StartMapReduceBlockingStub extends io.grpc.stub.AbstractStub<StartMapReduceBlockingStub> {
    ...
    /**
     */
    public stub.Master.APIResponse initiateSplit(stub.Master.Config request) {
      return blockingUnaryCall(
          getChannel(), getInitiateSplitMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class StartMapReduceFutureStub extends io.grpc.stub.AbstractStub<StartMapReduceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<stub.Master.APIResponse> initiateSplit(
        stub.Master.Config request) {
      return futureUnaryCall(
          getChannel().newCall(getInitiateSplitMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_INITIATE_SPLIT = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_INITIATE_SPLIT:
          serviceImpl.initiateSplit((stub.Master.Config) request,
              (io.grpc.stub.StreamObserver<stub.Master.APIResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (StartMapReduceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getInitiateSplitMethod())
              .build();
        }
      }
    }
